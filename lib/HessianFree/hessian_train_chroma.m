...
save_params = create_save_params(train_song_names, validation_song_names,...
  test_song_names, standardize_params, run, dbn_train_percentage,...
  left_frames_network, right_frames_network, is_chroma, {});
...
[paramsp layersizes, layertypes model_name] = ...
    ...
    weightcost, decay, jacket, save_params);
