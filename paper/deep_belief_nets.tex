...
avoiding the ``explaining away'' phenomenon (the set of visble or hidden
variables are indpenedent of each other given the other set). Assuming each of
...
where $\sigma$ is the logitistic sigmoid function. To obtain samples for the
...
For neural networks, it is intractible to compute the Hessian of the objective
